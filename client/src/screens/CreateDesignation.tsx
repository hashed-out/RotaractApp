...
function CreateDesignation() {
  ...
  const handleSubmit = async () => {
    try {
      await axios
        .post(`${URI}/createDesignation`,{designationName},{
          headers: {
      ...
      <View style={[styles.mainContainer]}>
        ...
        <View style={[styles.container]}>
          <TextInput
            ...
            onChangeText={text => setDesignationName(text)}
            placeholderTextColor="#000"
            style={styles.input}
          />
          <TouchableOpacity
            disabled={!designationName}
            style={!designationName ? styles.signupButtonDisabled : styles.signupButton}
